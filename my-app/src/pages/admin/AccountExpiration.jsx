  ...
  const onSubmit = async (e) => {
    ...
    if (type === "faculty") {
      ...
      const res = await axios.post(
        "http://localhost:8080/config/setStaffGlobalExpiry",
        {
          expirationDate: date,
        },
        {
      ...
      await axios.post(
        "http://localhost:8080/config/setStudentGlobalExpiry",
        {
          expirationDate: date,
        },
        {
    ...
    await axios.post(
      "http://localhost:8080/config/set-semester",
      {
        semester: sem,
      },
      {
  ...
  const getExpirations = async () => {
    try {
      const res = await axios.get(
        "http://localhost:8080/config/get-expiration"
      );
